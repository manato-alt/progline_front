  ...
  return (
    ...
    >
      <div className="bg-white mx-[10px] px-[30px] min-[900px]:mx-[100px] min-[1500px]:mx-[328px] min-[900px]:px-[60px]">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">未成年による利用</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">ログイン情報の管理</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">コンテンツのご利用</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">ポイント</h2>
        <p className="mb-4">
          当社は、当社又は本サービス独自のポイントを発行することがあります。この場合の詳細は、本サービス内その他当社所定の場所において別途定めるところによります。
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2">仮想通貨</h2>
        <p className="mb-4">
          当社は、当社又は本サービス独自の仮想通貨（以下「本仮想通貨」といいます。）を発行することがあります。
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2">遅延損害金</h2>
        <p className="mb-4">
          当社に対する金銭債務の支払を遅滞したユーザーは、当社に対し、年14.6％の割合による遅延損害金を支払うものとします。
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2">ユーザーの投稿</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">広告の表示</h2>
        <p className="mb-4">
          当社は、本サービスに当社または第三者の広告を掲載することができるものとします。
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2">禁止事項</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-2">換金行為の禁止</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">反社会的勢力の排除</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">利用制限</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">サービス内容の変更</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">利用規約の変更</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">個人情報の取扱い</h2>
        <p className="mb-4">
          本サービスの利用によって取得するユーザーの個人情報については、当社のプライバシーポリシーに従い適切に取り扱うものとします。
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2">通知または連絡</h2>
        <p className="mb-4">
          ユーザーと当社との間の通知または連絡は、当社の定める方法によって行うものとします。当社は、ユーザーから、当社が別途定める方式に従った変更届け出がない限り、現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い、これらは、発信時にユーザーへ到達したものとみなします。
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2">権利義務の譲渡</h2>
        <p className="mb-4">
          ユーザーは、当社の書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2">事業譲渡</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">適用関係</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">分離可能性</h2>
        <p className="mb-4">
