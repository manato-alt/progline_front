...
export default function HoverSquare({ id, handleClick, isSelected }) {
  ...
  return (
    <div
      className={`mb-[8px] flex px-[14px] py-[1px] justify-center rounded min-[700px]:rounded-xl items-center cursor-pointer min-[700px]:w-[7rem] min-[700px]:h-[6rem] min-[1000px]:w-[10rem] min-[1000px]:h-[7rem] ${
